    ...
    <RootView>
      <View style={{ position: "relative" }}>
        <Image
          ...
          width={208}
          height={208}
          className="w-[50%] md:w-[40%] lg:w-[30%] opacity-10 absolute right-8 top-8 bg-black"
        />
        <View>
          <View className="flex-row items-center p-4 py-8">
            ...
            <Text className="text-2xl font-bold flex-1">{pokemon?.name}</Text>
          ...
          <Image
            ...
            className="w-3/5 aspect-square mx-auto bg-black"
            resizeMode="contain"
          />
